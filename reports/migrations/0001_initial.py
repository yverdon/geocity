    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('polymorphic_ctype', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='polymorphic_reports.section_set+', to='contenttypes.contenttype')),
        ...
        migrations.CreateModel(
            name='SectionAuthor',
            fields=[
                ('section_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='reports.section')),
            ],
            options={
                'abstract': False,
        ...
        migrations.AddField(
            model_name='report',
            name='layout',
            field=models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='reports.reportlayout'),
        ),
        migrations.AddField(
            model_name='report',
            name='type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='permits.complementarydocumenttype'),
        ),
        migrations.AddField(
            model_name='report',
