...
class Command(BaseCommand):
    ...
    def create_works_types(self):
        properties = {
            ...
            "comment": models.WorksObjectProperty.objects.create(
                name="Autres", input_type="text", is_mandatory=False, order=2
            ),
    ...
    def setup_global_config(self):
        ...
        config.LOCATION_STEP = "Choisissez le sondage"
        config.PROPERTIES_STEP = "Renseignez les informations"
        config.GEO_STEP = "Cliquez sur les espaces publics à proximité de chez vous que vous connaissez ou faites de nouvelles propositions"
