...
class Command(BaseCommand):
    ...
    def create_users(self):
        ...
        administrative_entity_a = models.PermitAdministrativeEntity.objects.create(
            name="Quartier A",
            ofs_id=0,
            link="https://mapnv.ch",
        ...
        administrative_entity_a.tags.set("ep5")
        administrative_entity_b = models.PermitAdministrativeEntity.objects.create(
            name="Quartier B",
            ofs_id=1,
            link="https://mapnv.ch",
            archive_link="https://mapnv.ch",
        ...
        administrative_entity_b.tags.set("ep5")
    ...
    def create_works_types(self):
        properties = {
            ...
            "comment": models.WorksObjectProperty.objects.create(
                name="Remarque(s)", input_type="text", is_mandatory=False, order=2
            ),
            ...
            "list_multiple": models.WorksObjectProperty.objects.create(
                name="Pourquoi vous arretez-vous dans des espaces publics",
                input_type="list_multiple",
                is_mandatory=False,
                choices="Me détendre/prendre l'air\nÊtre actif\nConsommer\nRencontrer des gens\nJoueravec les enfants\nSortir avec les animaux",
                order=0,
            ),
            "list_frequence_saison": models.WorksObjectProperty.objects.create(
                name="Saison",
                input_type="list_multiple",
                is_mandatory=False,
                choices="Automne\nHiver\nPrintemps\nÉté",
            ...
            "list_frequence_horaire": models.WorksObjectProperty.objects.create(
                name="Horaire",
                input_type="list_multiple",
                is_mandatory=False,
                choices="Matin\nMidi\nSoir\nAprès-midi",
            ...
            "list_frequence": models.WorksObjectProperty.objects.create(
                name="Circonstances",
                input_type="list_multiple",
                is_mandatory=False,
                choices="Quotidien\nExceptionnel\nHebdomadaire\nFestif",
            ...
            "list_usages": models.WorksObjectProperty.objects.create(
                name="À l'avenir, quelles activités préféreriez-vous faire dans cet espace",
                input_type="list_multiple",
                is_mandatory=False,
                choices="Profiter de la nature\nMe poser\nParticiper\nRencontrer des gens\nJouer\nBouger / être actif",
                order=0,
            ),
             "title": models.WorksObjectProperty.objects.create(
                name="Informations vous concernant",
                input_type="title",
                help_text="Ce texte permet d'expliquer en détail à l'utilisateur les pourquoi et le comment des informations à fournir",
                is_mandatory=False,
                order=30,
            ),
            "list_genre": models.WorksObjectProperty.objects.create(
                name="Vous êtes ?",
                input_type="list_single",
                is_mandatory=False,
                choices="Femme\nHomme\nNon binaire\nEnfant (0-11)\nJeune/étudiant (12-23ans)\nAdulte\nSénior",
                order=31,
            ),
        }
        works_types = [
            (
                "Connaissez-vous ces espaces publics à proximité de chez vous ?",
                [
                    (
                        "A",
                        properties["list_frequence_saison"],
                        properties["list_frequence_horaire"],
                        properties["list_frequence"],
                        properties["list_usages"],
                        properties["comment"],
                    ),
                    (
                        "B",
            ...
            (
                "Quels sont les espaces que vous utilisez le plus ?",
                [
                    (
                        "A",
                        properties["list_frequence_saison"],
            ...
            (
                ...
                [
                    (
                        ...
                        properties["list_genre"],
                        properties["comment"],
                    ),
                ],
            ),
        ]
        administrative_entity_a = models.PermitAdministrativeEntity.objects.get(
            name="Quartier A",
        )
        administrative_entity_a.tags.set("ep5")
        administrative_entity_b = models.PermitAdministrativeEntity.objects.get(
            name="Quartier B",
        )
        administrative_entity_b.tags.set("ep5")
        ...
        for works_type, objs in works_types:
            ...
            for works_obj, *props in objs:
                works_obj_obj, created = models.WorksObject.objects.get_or_create(
                    name=works_obj,
                    wms_layers="https://mapnv.ch/mapserv_proxy?ogcserver=QGIS-server-geocity&SERVICE=WMS&VERSION=1.3.0&REQUEST=GetMap&CRS=EPSG:2056&LAYERS=espaces_publics&FORMAT=image/png",
                )
    ...
    def setup_global_config(self):
        ...
        config.LOCATION_STEP = "Dans quel quartier habitez-vous ?"
        config.PROPERTIES_STEP = "Votre expérience, votre avis sur les espaces publics sélectionnés"
        config.GEO_STEP = "Placez sur la carte les nouveaux espaces que vous souhaiteriez"
