...
class SelectablePermitRequestTable(ColumnShiftTable):
    check = PermitRequestCheckboxColumn(accessor="id", verbose_name=_("Archiver"))
...
class ArchivedPermitRequestsTable(ColumnShiftTable):
    check = PermitRequestCheckboxColumn(accessor="permit_request_id", verbose_name=_("Télécharger"))
