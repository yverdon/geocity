# Generated by Django 2.2.6 on 2020-06-09 13:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_first', models.CharField(max_length=20, null=True, validators=[django.core.validators.RegexValidator(message='Seuls les chiffres et les espaces sont autorisés', regex='^(\\s*[0-9]+\\s*)+$')], verbose_name='Téléphone principal')),
                ('phone_second', models.CharField(blank=True, max_length=20, null=True, validators=[django.core.validators.RegexValidator(message='Seuls les chiffres et les espaces sont autorisés', regex='^(\\s*[0-9]+\\s*)+$')], verbose_name='Téléphone secondaire')),
