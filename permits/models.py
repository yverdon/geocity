...
class PermitRequest(models.Model):
    ...
    administrative_entity = models.ForeignKey(
        PermitAdministrativeEntity, on_delete=models.CASCADE, verbose_name=_("commune"), related_name='permit_requests'
    )
    author = models.ForeignKey(
        PermitAuthor, null=True, on_delete=models.SET_NULL, verbose_name=_("auteur"), related_name='permit_requests'
    )
...
class WorksObjectProperty(models.Model):
    ...
    works_object_types = models.ManyToManyField(WorksObjectType,
                                                verbose_name=_("objets des travaux"), related_name='properties')
...
class PermitRequestValidation(models.Model):
    ...
    department = models.ForeignKey(
        "PermitDepartment", on_delete=models.CASCADE, related_name="permit_request_validations"
    )
...
class PermitRequestGeoTime(models.Model):
    ...
    class Meta:
        verbose_name = _("Agenda et localsation")
