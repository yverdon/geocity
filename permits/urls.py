...
existing_permit_request_urlpatterns = [
    ...
    path('submitconfirmation/', views.permit_request_submit_confirmation, name='permit_request_submit_confirmation'),
    path('submitconfirmed/', views.permit_request_submit_confirmed, name='permit_request_submit_confirmed'),
...
urlpatterns = [
    ...
    path('administrative-entity-files/<path:path>', views.administrative_entity_file_download, name='administrative_entity_file_download'),
