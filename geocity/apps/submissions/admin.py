...
from geocity.apps.submissions.payments.models import PrestationsList
...
@admin.register(PrestationsList)
class PrestationsListAdmin(IntegratorFilterMixin, admin.ModelAdmin):
    list_display = [
        "name",
