...
class Migration(migrations.Migration):
    ...
    dependencies = [
        (
            "permits",
            "0022_add_field_tags_to_permitadministrativeentity_add_requires_payment_field_to_works_object_type_model_and_integrator",
        ),
    ]
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        max_length=500,
                        verbose_name="Liste des couches QGIS à afficher séparées par les virgules ','",
                    ),
                ),
                (
                    "qgis_atlas_coverage_layer",
                    models.CharField(
                        max_length=256,
                        verbose_name="Nom de la couche de couverture de l'atlas ','",
                    ),
                ),
