    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    permits.fields.AdministrativeEntityFileField(
                        ...
                        upload_to="administrative_entity_files/",
                ...
                (
                    ...
                    permits.fields.AdministrativeEntityFileField(
                        ...
                        storage=permits.fields.PrivateFileSystemStorage(),
                        upload_to="administrative_entity_files/",
                        verbose_name="Logo secondaire",
                    ),
                ),
                (
                    "title_signature_1",
                    models.CharField(
                        blank=True, max_length=128, verbose_name="Signature Gauche"
                    ),
                ),
                (
                    "image_signature_1",
                    permits.fields.AdministrativeEntityFileField(
                        ...
                        storage=permits.fields.PrivateFileSystemStorage(),
                        upload_to="administrative_entity_files/",
                        verbose_name="Signature gauche",
                    ),
                ),
                (
                    "title_signature_2",
                    models.CharField(
                        blank=True, max_length=128, verbose_name="Signature Droite"
                    ),
                ),
                (
                    "image_signature_2",
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        validators=[
                            django.core.validators.RegexValidator(
                                message="Le code d'entreprise doit être de type                          CHE-123.456.789 (TVA)                          et vous pouvez le trouver sur                          le registe fédéral des entreprises                          https://www.uid.admin.ch/search.aspx",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_archeologist",
                    models.BooleanField(verbose_name="is_archeologist"),
                ),
                (
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        verbose_name="permit_administrative_entity",
                    ),
                ),
                (
                    "group",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "comment",
                    models.TextField(
                        blank=True, verbose_name="Analyse du service pilote"
                    ),
                ),
                (
                    "validation_pdf",
                    permits.fields.PermitRequestFileField(
                        storage=permits.fields.PrivateFileSystemStorage(),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                through="permits.WorksObjectType",
                to="permits.WorksType",
                verbose_name="types",
            ),
        ),
        ...
        migrations.AddField(
            ...
            name="actors",
            field=models.ManyToManyField(
                related_name="_permitrequest_actors_+",
                through="permits.PermitRequestActor",
                to="permits.PermitActor",
            ),
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "comment_before",
                    models.TextField(blank=True, verbose_name="Commentaires (avant)"),
                ),
                (
                    "comment_during",
                    models.TextField(blank=True, verbose_name="Commentaires (pendant)"),
                ),
                (
                    "comment_after",
                    models.TextField(blank=True, verbose_name="Commentaires (après)"),
                ),
                (
                    "validated_at",
