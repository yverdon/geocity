...
# Generic views for the API, the views aren't listed as router.register
api_urlpatterns = [
    # API to create user
    path(
        "permitauthorcreate/",
        api.PermitAuthorCreateAPI.as_view(),
        name="permitauthorcreate",
    ),
]
...
urlpatterns += [
    ...
    path("rest/", include(router.urls + api_urlpatterns)),  # Django-rest urls
