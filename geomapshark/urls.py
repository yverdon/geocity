...
if settings.ENABLE_2FA:
    ...
    urlpatterns += [
        path('account/login/', LoginView.as_view(template_name='two_factor/login.html'), name='login'),
    ...
    urlpatterns += [path('accounts/login/', auth_views.LoginView.as_view(), name='login')]
