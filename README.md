...
- `edit_submission`, "Éditer les demandes": allow the user to edit the requests filled by another person
- `read_submission`, "Consulter les demandes": allow a trusted user to only read submissions without any other permission
- `edit_submission_validations`, "Éditer les validations": allow the pilot to edit the validation to correct spelling mistakes
